...
var TextField = _react2.default.createClass({
  ...
  propTypes: {
     ...
     */
    floatingLabelShrink: _react2.default.PropTypes.bool,
  ...
  render: function render() {
    ...
    var floatingLabelShrink = _props.floatingLabelShrink;
    ...
    var other = _objectWithoutProperties(_props, ['className', 'disabled', 'errorStyle', 'errorText', 'floatingLabelText', 'floatingLabelShrink', 'fullWidth', 'hintText', 'hintStyle', 'id', 'multiLine', 'onBlur', 'onChange', 'onFocus', 'style', 'type', 'underlineDisabledStyle', 'underlineFocusStyle', 'underlineShow', 'underlineStyle', 'rows', 'rowsMax']);
